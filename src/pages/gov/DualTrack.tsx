...
// ===== 管理企业规模 =====
const scaleCards = [
  { label: "企业总数", value: 545, unit: "家", icon: Building2, color: "hsl(217 91% 56%)", bg: "hsl(217 91% 56% / 0.12)" },
  ...
  { label: "百千家", value: 8, unit: "家", icon: Award, color: "hsl(217 91% 56%)", bg: "hsl(217 91% 56% / 0.12)" },
];
...
const industryColors = [
  "hsl(217 91% 56%)", "hsl(200 90% 60%)", "hsl(190 85% 55%)", "hsl(170 70% 50%)",
  "hsl(152 65% 50%)", "hsl(220 60% 45%)", "hsl(217 70% 65%)", "hsl(195 80% 50%)",
  "hsl(180 60% 55%)", "hsl(220 15% 60%)",
];
...
// ===== 月度关键数据 (能碳指标) =====
const monthlyKpi = [
  { label: "累计碳排放量", value: "2,386.3", unit: "万tCO2", icon: Factory, color: "hsl(217 91% 56%)" },
  { label: "累计综合能耗(等价值)", value: "954.5", unit: "万tce", icon: Flame, color: "hsl(217 91% 56%)" },
  { label: "累计电耗", value: "97.0", unit: "亿kWh", icon: Zap, color: "hsl(217 91% 56%)" },
  { label: "累计绿色电力/可再生/绿证消耗", value: "24.8", unit: "亿kWh", icon: Wind, color: "hsl(152 65% 50%)" },
];

// ===== 年度关键数据 =====
const yearlyKpi = [
  { label: "累计碳排放量", value: "14,506.4", unit: "万tCO2e", icon: Factory, color: "hsl(217 91% 56%)" },
  { label: "累计综合能耗(等价值)", value: "4,326.9", unit: "万tce", icon: Flame, color: "hsl(217 91% 56%)" },
  { label: "累计电耗", value: "601.1", unit: "亿kWh", icon: Zap, color: "hsl(217 91% 56%)" },
...
// 限额对标
const quotaResults = [
  { label: "1 优于先进值", value: 55, color: "hsl(217 91% 56%)" },
  { label: "2 限额值至准入值之间", value: 28, color: "hsl(217 91% 56%)" },
  { label: "3 准入值至先进值之间", value: 16, color: "hsl(217 91% 56%)" },
  { label: "4 低于限额值", value: 1, color: "hsl(217 91% 56%)" },
];
const benchResults = [
  { label: "1 标杆水平至基准水平之间", value: 68, color: "hsl(217 91% 56%)" },
  { label: "2 优于标杆水平", value: 32, color: "hsl(217 91% 56%)" },
  { label: "3 低于基准水平", value: 0, color: "hsl(217 91% 56%)" },
];
