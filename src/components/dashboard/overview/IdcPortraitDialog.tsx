...
const TABS = [
  { key: "PUE", label: "PUE", unit: "", color: "hsl(217 91% 56%)" },
  { key: "上架率", label: "上架率(%)", unit: "%", color: "hsl(217 91% 56%)" },
          ...
          <div className="grid grid-cols-12 gap-4">
            ...
            <div className="col-span-12 lg:col-span-5 panel p-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  { label: "综合能耗", value: "1.0", unit: "万tce", icon: Flame, color: "hsl(217 91% 56%)" },
                  { label: "总电能消耗", value: "3,317.6", unit: "万kwh", icon: Zap, color: "hsl(40 95% 55%)" },
                  { label: "PUE", value: idc.pue.toFixed(1), unit: "", icon: Gauge, color: "hsl(217 91% 56%)" },
                ].map((it) => {
                  const Icon = it.icon;
                  return (
