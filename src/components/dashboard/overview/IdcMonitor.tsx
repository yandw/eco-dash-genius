...
const dataMap: Record<(typeof tabs)[number], { label: string; pct: number; count: number; color: string }[]> = {
  综合能耗: [
    ...
    { label: "10000≤X<30000", pct: 47.2, count: 25, color: "hsl(217 91% 56%)" },
    { label: "5000≤X<10000", pct: 15.1, count: 8, color: "hsl(200 90% 55%)" },
  ...
  机柜数量: [
    ...
    { label: "1000≤X<5000", pct: 50.9, count: 27, color: "hsl(217 91% 56%)" },
    { label: "500≤X<1000", pct: 15.1, count: 8, color: "hsl(200 90% 55%)" },
  ...
  PUE评价: [
    ...
    { label: "1.3≤PUE<1.5", pct: 43.4, count: 23, color: "hsl(217 91% 56%)" },
    { label: "1.2≤PUE<1.3", pct: 17.0, count: 9, color: "hsl(200 90% 55%)" },
